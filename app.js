...
app.listen(8888, () => {
  ...
  console.log(`user server started at portnumber : http://localhost:${process.env.PORT}`)
  console.log(`admin server started at portnumber : http://localhost:${process.env.PORT}/admin`)
